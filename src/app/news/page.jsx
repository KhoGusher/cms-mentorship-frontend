        ...
        <div>
            ...
            <div className="grid grid-cols-12 gap-4 p-4">
                <div className="col-span-12 lg:col-span-8">
                    <div className="pt-[4vh] lg:px-[10vw]">
                        <div>
                            <NewsContainer />
                            <NewsContainer />
                            <NewsContainer />
                ...
                <div className="col-span-12 lg:col-span-4 bg-white border border-gray-500 p-4 h-auto lg:h-[100vh] lg:mr-5 pt-[4vh] mt-6 rounded-md">
                    <div>
