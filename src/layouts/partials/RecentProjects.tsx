      ...
      {data.frontmatter.enable && (
        <section className="section">
          <div className="container">
            <div className="row">
              <div className="mx-auto mb-6 text-center md:col-10 lg:col-8 xl:col-6">
                {/* <h2
              ...
              <div className="col-12">
                    ...
                    (item: Testimonial, index: number) => (
                      <SwiperSlide key={index}>
                        <div className="rounded-lg bg-theme-light px-7 py-10 dark:bg-darkmode-theme-light">    
                          ...
                          />
                          {/* <button className="btn-primary mt-4 py-2 px-4">Learn More</button> */}
                        </div>
                      </SwiperSlide>
                    )
                  )}
                ...
                <div className="text-center mt-6">
                  <a className="btn btn-primary" href="/projects">More Projects</a>
